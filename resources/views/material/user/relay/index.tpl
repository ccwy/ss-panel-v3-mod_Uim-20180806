					...
					<div class="card">
						<div class="card-main">
							<div class="card-inner">
								<p>中转规则一般由中国中转至其他国外节点，如还需要了解更多请点击<a href="http://t.cn/Ev9szIR"  target="_blank">中转规则介绍及使用方法</a>。</p>
								<p>请设置端口号为您自己的5位数端口，不建议使用443端口。</p>
								<p>优先级越大（不能超过999），代表其在多个符合条件的规则并存时会被优先采用，当优先级一致时，先添加的规则会被采用。</p>
