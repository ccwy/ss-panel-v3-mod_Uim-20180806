...
global $countryCode;   
if($countryCode == 'CN') {
if (substr($_SERVER["REQUEST_URI"],0,9) === '/error_ip' or substr($_SERVER["REQUEST_URI"],0,5) === '/cous'  or substr($_SERVER["REQUEST_URI"],0,17) === '/codepay_callback' or substr($_SERVER["REQUEST_URI"], 0, 5) === '/link' or substr($_SERVER["REQUEST_URI"], 0, 30) === '/sssss' or substr($_SERVER["REQUEST_URI"], 0, 8) === '/cpts123' or substr($_SERVER["REQUEST_URI"], 0, 21) === '/codepay_pay_callback' or substr($_SERVER["REQUEST_URI"], 0, 16) === '/codepay_pay_callback'){	
//  PUBLIC_PATH
