 ...
 public function node_admin($request, $response, $args)
    ...
    public function code($request, $response, $args)
    {
        ...
        if (Config::get('payment_system') == 'chenAlipay') {
            $config = new AliPay();
            return $this->view()->assign('codes', $codes)->assign('QRcodeUrl', $config->getConfig('AliPay_QRcode'))->assign('WxQRcodeUrl', $config->getConfig('WxPay_QRcode'))->assign('pmw', Pay::getHTML($this->user))->display('user/code.tpl');
        } else {
